        ...
        <div className="pt-32 pb-20 px-6">
            <div className="max-w-7xl mx-auto">
                <header className="text-center mb-16">
                    <h1 className="text-5xl md:text-6xl font-serif font-bold text-burgundy-950 mb-6 underline decoration-gold-500 underline-offset-8">Our Portfolio</h1>
                ...
                <div className="flex flex-wrap justify-center gap-4 mb-16">
                    <button
                        ...
                        className={`px-6 py-2 rounded-full border transition-all duration-300 ${activeCategory === 'all'
                                ? 'bg-burgundy-900 text-white border-burgundy-900 shadow-md'
                                : 'bg-white text-burgundy-900 border-burgundy-200 hover:border-burgundy-900'
                            }`}
                    >
                        All Works
                    </button>
                            ...
                            >
                                <div className="aspect-[4/5] overflow-hidden bg-gray-100">
                                    {project.imageUrls && project.imageUrls.length > 0 ? (
                                        ...
                                        <div className="flex items-center justify-center h-full text-burgundy-200 italic font-serif opacity-30">
                                            {project.category.name}
                                        </div>
                                    )}
                                </div>
                                <div className="absolute inset-x-4 bottom-4 p-6 bg-white/90 backdrop-blur-md rounded-2xl transform translate-y-2 group-hover:translate-y-0 transition-transform">
                                    <p className="text-xs font-bold text-gold-600 uppercase tracking-[0.2em] mb-2">{project.category.name}</p>
                                    <h3 className="text-2xl font-serif font-bold text-burgundy-950 mb-2">{project.title}</h3>
